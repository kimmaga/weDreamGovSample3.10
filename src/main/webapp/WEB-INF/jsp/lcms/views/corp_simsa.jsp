...
<html lang="ko">
	...
	<script src="/js/lcms/common.js"></script>
			...
			<div class="data_tbl">
				<table>
					<caption> 대출모집법인 등록 심사 현황입니다. 번호, 회원사, 심사대상, 신청일자, 심사일자, 심사결과, 보완사유</caption>
					<colgroup>
						<col style="width:8%">
						<col style="width:15%">
						<col style="width:12%">
					...
					<thead>
						<tr>
							<th>NO <button type="button" class="sortup">정렬</button></th><th>회원사<button type="button" class="sortdown">정렬</button></th><th>심사대상<button type="button" class="sortup">정렬</button></th><th>신청일자<button type="button" class="sortup">정렬</button></th><th>심사일자<button type="button" class="sortup">정렬</button></th><th>심사결과<button type="button" class="sortup">정렬</button></th><th>보완사유</th>
						</tr>
					</thead>
					<tbody>
						<tr>
			...
			<div class="pagination">
				...
				<a href="#" class="arr first" onclick=""><img src="/images/lcms/arr_first.png" alt="첫페이지보기버튼"></a>
				<a href="#" class="arr prev" onclick=""><img src="/images/lcms/arr_prev.png" alt="이전페이지보기버튼"></a>
				...
				<a href="#" class="arr next" onclick=""><img src="/images/lcms/arr_next.png" alt="다음페이지보기버튼"></a>
				<a href="#" class="arr last" onclick=""><img src="/images/lcms/arr_last.png" alt="마지막페이지보기버튼"></a>
			</div>
			</div>
		</section>