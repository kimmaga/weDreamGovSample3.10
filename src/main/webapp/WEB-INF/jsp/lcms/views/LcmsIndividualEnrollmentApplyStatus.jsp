...
<html lang="ko">
	...
	<section id="contents">
		...
		<div class="btn_wrap btn_right">
			<button type="button" class="btn_blue">등록신청하기</button>
		</div>
		...
		<div class="pagination">
			...
			<a href="#" class="arr first" onclick=""><img src="../img/arr_first.png" alt="첫페이지보기버튼"></a>
			<a href="#" class="arr prev" onclick=""><img src="../img/arr_prev.png" alt="이전페이지보기버튼"></a>
			...
			<a href="#" class="arr next" onclick=""><img src="../img/arr_next.png" alt="다음페이지보기버튼"></a>
			<a href="#" class="arr last" onclick=""><img src="../img/arr_last.png" alt="마지막페이지보기버튼"></a>
		</div>
